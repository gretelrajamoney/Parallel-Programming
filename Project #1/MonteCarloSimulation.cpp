...
main( int argc, char *argv[ ] )
{
        ...
        // fprintf(stderr,"num threads, num trials, probability, megatrials\n");
        ...
        // fprintf(stderr, "%2d threads : %8d trials ; probability = %6.2f%% ; performance = %6.2lf\n",
        fprintf(stderr, "%2d,%8d, %6.2f%%, %6.32f\n",NUMT,NUMTRIALS,100.*probability,maxPerformance);
                // NUMT, NUMTRIALS, 100.*probability, maxPerformance);
