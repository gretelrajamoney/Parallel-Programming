...
// PART 3: Multiply Two Arrays but with a Reduction
...
main( int argc, char *argv[ ] )
{
    ...
    // REFERENCE: syntax taken from Slide 5 of Performing Reductions in OpenCL
    ...
    // REFERENCE: syntax taken from Slide 10 of Performing Reductions in OpenCL
    Wait( cmdQueue );
